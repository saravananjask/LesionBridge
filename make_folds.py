...
def make_segmentation_folds():
    ...
    print("  NOTE: no public patient ID exists for either dataset; DDR's filename "
          "prefix was checked and rejected as a grouping proxy (see docstring). "
          "Folds are plain random at image level - disclose this in the paper.")
